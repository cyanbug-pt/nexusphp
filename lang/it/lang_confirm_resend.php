...
(
	'resend_confirmation_email_failed' => "Invia email di conferma non riuscita",
	'std_fields_blank' => "Non lasciare nessun campo vuoto.",
	...
	'std_error' => "Errore",
	'std_database_error' => "Errore nel database. Contatta un amministratore per questo.",
	'text_resend_confirmation_mail_note' => "<h1>Invia di nuovo una mail di conferma </h1><p>Usa il modulo qui sotto per inviare nuovamente la tua email di conferma.</p><p>Devi essere registrato entro 1 giorno e non confermato,<br />altrimenti il tuo account in sospeso potrebbe essere eliminato e dovresti registrarti di nuovo.</p><p><b>Nota:</b> %s tentativi falliti di riga comporteranno il divieto del tuo ip!</p>",
	'row_registered_email' => "Email registrata: ",
	...
	'mail_title' => " Conferma Registrazione Utente (Ri-Invia)",
	'mail_this_link' => "QUESTO LINK",
	'mail_here' => "QUI",
	'mail_one' => "Hi ",
	'mail_two' => ",<br /><br />Hai richiesto una nuova email di conferma su %s e hai <br />specificato questo indirizzo ",
